export default function Home({ isProxy, shop, queryParams }) {
  ...
  return (
    <div style={{ fontFamily: "Arial, sans-serif", padding: 20 }}>
      ...
      <a href="https://localhost:3000/api/auth?shop=dev-store-749237498237498330.myshopify.com">
        install
      </a>
      <p>
        To install the app, open:{" "}
        <code>/api/auth?shop=your-shop.myshopify.com</code>
      </p>
    </div>
  );
}
